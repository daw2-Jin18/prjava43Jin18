...
public class Prjava43Jin18 extends Frame
   ...
   public Prjava43Jin18 () {
      ...
      setTitle("nova finestra prjava43cognom18");  // "this" Frame sets title
   ...
   public static void main(String[] args) {
      new Prjava43Jin18();  // Let the construct do the job
   }
